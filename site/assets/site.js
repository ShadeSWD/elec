...
(function () {
  ...
  header.innerHTML = `<div class="wrap">
    <a class="logo" href="${root}">${logoSvg}<span>Корабельное электрооборудование</span></a>
  ...
  footer.innerHTML = `<div class="wrap">
    <div>Учебный сайт по курсам «Электротехника» и «Электрооборудование и энергоустановки кораблей и судов» · 4-й семестр</div>
